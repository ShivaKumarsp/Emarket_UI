...
export class HubManagerLoginCreationComponent implements OnInit {
 ...
 submitted = false;
  ...
  hubmanagervalid = new UntypedFormGroup({
    firstname: new UntypedFormControl('', [Validators.required, Validators.minLength(3), Validators.maxLength(15)]),
    lastname: new UntypedFormControl(''),
    email: new UntypedFormControl('', [Validators.required,Validators.pattern("^[a-z]+[a-z0-9._]+@[a-z]+\.[a-z.]{2,5}$")]),
    phonenumber: new UntypedFormControl('', [Validators.required,Validators.pattern("^[6-9]{1}[0-9]{9}$")]),
    address: new UntypedFormControl('', [Validators.required,Validators.minLength(5),Validators.pattern("[0-9\\\/# ,a-zA-Z]+[ ,]+[0-9\\\/#, a-zA-Z]{1,}")]),
    countryid: new UntypedFormControl('', [Validators.required]),
    state: new UntypedFormControl('', [Validators.required]),
    city: new UntypedFormControl('', [Validators.required]),
    pincode: new UntypedFormControl('', [Validators.required,Validators.pattern("^[1-9]{1}[0-9]{2}\s{0,1}[0-9]{3}$")]),
    ...
    profilepic:new UntypedFormControl('',[Validators.required]),
    v_hub:new UntypedFormControl('',[Validators.required]),
    r_pwdd:new UntypedFormControl('',[Validators.required])
  });
